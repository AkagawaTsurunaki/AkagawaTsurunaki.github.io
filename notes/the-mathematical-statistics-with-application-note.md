...
- **几乎处处收敛**：$X_n \xrightarrow{a.s.} X ⇔ P \left( \{w: lim_{n \rightarrow +\infty} X_n(w) = X(w) \} \right) = 1 $
...
<img src="assets\卡方分布分位数.png" width="300">
...
<img src="assets\t分布分位数.png" width="300">
...
<img src="assets\F分布分位数.png" width="300">
...
$X_1, \dots, X_{n_1} \sim N(\mu_1, \sigma_1^2), \ Y_1, \dots, Y_{n_2} \sim N(\mu_2, \sigma^2_2) $
$$
\bar{X} = \dfrac{1}{n_1} \sum_{i=1}^{n_1}X_i, \quad S_1^2=\dfrac{1}{n_1 - 1} \sum_{i=1}^{n_1} (X_i - \bar{X})^2
\\
...
|                                               |                                                              | 未知              | $\left\{ \left|  \dfrac{\bar{X} - \mu_0 }{S/\sqrt{n}}  \right|> t_{\alpha/2} (n-1) \right\}  $ |

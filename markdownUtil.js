...
exports.getMarkdownFileInfoByPath = getMarkdownFileInfoByPath;
exports.getMarkdownFileInfo = getMarkdownFileInfo;
async function getMarkdownFileInfoByPath(publicPath, maxLength = 200) {
...
function getMarkdownFileInfo(text, maxLength = 200) {
    try {
        ...
        if (indexOfFirstBr > 0) {
            return {
                ...
                preview: preview.slice(indexOfFirstBr + 1, indexOfFirstBr + 1 + Math.max(0, preview.length)) +
                    '...',
            };
        }
...
function getIndexOfFirstH1(text) {
...
function getIndexOfFirstBr(str) {
